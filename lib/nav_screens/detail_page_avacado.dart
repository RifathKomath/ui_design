...
class _DetailPageAvacadoState extends State<DetailPageAvacado> {
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(
            children: [
              SizedBox(
                  height: 150, child: Image.asset('assets/image/pngegg.png')),
              const SizedBox(
                height: 20,
              ),
              customItemText(
                  ...
                  label_3: '/st',
                  label_4:
                      '''Avocados are nutrient-rich fruits known for their creamy texture and high content of healthy fats, particularly heart-friendly monounsaturated fats. They're also a good source of vitamins, minerals, and fiber, making them a popular choice in healthy diets.'''),
              const SizedBox(
                height: 20,
              ),
              Padding(
