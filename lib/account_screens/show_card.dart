...
class _ShowCardState extends State<ShowCard> {
  ...
  List<String> images = ['assets/image/Group 237.png','assets/image/Group 237.png','assets/image/Group (2).png'];
  List<IconData>icons = [Icons.arrow_forward_ios_rounded,Icons.arrow_forward_ios_rounded,Icons.check];
    ...
    return Scaffold(
       appBar: PreferredSize(
          ...
          body: ListView.separated(itemBuilder: (context , index){
              return customShowCrdListView(image: images[index], icon: icons[index], label: titles[index], subLabel: subTitles[index]);
